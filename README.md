...
RaySkillKit now ships with a compact catalogue of six skills that blend legacy validation fixtures with the new travel pack produced by the `raycli` workflow:
