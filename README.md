...
RaySkillKit now ships with a compact catalogue of nine skills that blend legacy validation fixtures with the travel and retail packs produced by the `raycli` workflow:
