...
class ActionDispatcher(
    ...
    /**
     * Remember a note by appending it to SharedPreferences.
     *
     * Uses a simple delimiter-based approach to store multiple notes.
     * Notes are stored non-blocking using apply().
     */
    private fun handleRememberNote(action: SmartGlassAction.RememberNote) {
        ...
        Log.d(TAG, "RememberNote: Stored note: ${action.note}")
    }
